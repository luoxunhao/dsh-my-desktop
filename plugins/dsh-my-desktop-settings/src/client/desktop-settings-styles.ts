...
.dshDesktopSettingsChoice.dshDesktopSettingsChoiceStatic { cursor: default; }
.dshDesktopSettingsChoice.dshDesktopSettingsChoiceStatic:hover { background: var(--dsw-alias-bg-layer-1); }
