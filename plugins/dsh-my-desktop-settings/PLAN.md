...
> 目标运行时基线 = dsh-my-desktop 随包的官方 `@deepseek-ai/dsh@0.1.5-rc.2`（实测其 node_modules 内含
> `dsh-client-ui-settings@0.1.5-rc.2`、`dsh-client-locale@0.1.5-rc.2`、`dsh-client-ui-renderer@0.1.5-rc.2`、`cordis@4.0.2`）。
