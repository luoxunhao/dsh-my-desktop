...
window.dshShell = {
  ...
  getDesktopUpdateState: async () => ({ currentVersion: '0.2.0', packaged: true, status: { kind: 'none' } }),
  desktopUpdateAction: async () => ({ currentVersion: '0.2.0', packaged: true, status: { kind: 'none' } }),
