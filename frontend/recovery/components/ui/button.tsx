 ...
 * (`native-ui/components/ui/button.tsx`) — same variants, same sizes, same classes,
 * so the recovery page's buttons are pixel-identical to `dsh-desktop`'s. Only the
 * import paths differ.
 *
 * Built on `@base-ui/react`'s Button primitive, which supplies the accessible
 * button semantics; the styles are ours.
 */
